...
data class ExchangeRates(
    ...
    @SerialName("BRL") val brt: Double?,
    @SerialName("BSD") val bid: Double?,
    @SerialName("BTN") val bon: Double?,
    ...
    @SerialName("TRY") val tryRate: Double?,
...
data class ExchangeRateResponse(
    ...
    @SerialName("conversion_rates") val conversionRates: ExchangeRates
)
